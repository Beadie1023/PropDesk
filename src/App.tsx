  ...
  return (
    <div className="min-h-screen bg-ink-950 grid-bg">
      ...
      <main className="mx-auto max-w-[1600px] px-6 py-6">
        {error && (          <div className="mb-5 rounded-xl border border-bear-500/40 bg-bear-500/10 px-5 py-3 text-sm text-bear-300">
        ...
        {view === 'overview' && (
          <div className="space-y-6">
            ...
            {/* New tracker sits above journal so violations show before logging */}
            <ConsistencyTracker 
              dailyPnL={dailyPnL} 
